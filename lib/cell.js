class Cell {
    ...
    hasNeighbors(directionsArray) {
        ...
        directionsArray.forEach(function(dir) {
            switch(dir) {
                case "north":
                    if (cell.grid.getCell(cell.x, cell.y - 1).value > 0 && cell.grid.getCell(cell.x, cell.y - 1).value < 4) {
                        hasNeighbors = true;
                    }
                    break;
                case "south":
                    ...
                    break;
                case "east":
                    if (cell.grid.getCell(cell.x + 1, cell.y).value > 0 && cell.grid.getCell(cell.x + 1, cell.y).value < 4) {
                        hasNeighbors = true;
                    }
                    break;
                case "west":
