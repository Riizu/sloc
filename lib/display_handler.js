class DisplayHandler {
  ...
  drawStartSplash() {
    ...
    xPos = (this.context.canvas.width) / 2 - 150;
    yPos = (this.context.canvas.height) / 2 + 50;
    this.context.fillText("Press Space to begin", xPos, yPos);
  }
  ...
  drawGameOver() {
    ...
    xPos = (this.context.canvas.width) / 2 - 150;
    yPos = (this.context.canvas.height) / 2 + 50;
    this.context.fillText("Press Space to restart", xPos, yPos);
  }
